...
# infile_name = "precipitation_mswep_monthly_1979_2021.nc"
# varname = "precipitation"
# outfile = paste0("SPI3_mswep_monthly_baseline_", baseline[1], "to",  baseline[2], ".nc")

outfile_name = "SPI3_chirps_monthly_1981_2021.nc"
infile_name = "chirps_monthly_1981_2021.nc"
varname = "precip"
outfile = paste0("SPI3_chirps_monthly_baseline_", baseline[1], "to",  baseline[2], ".nc")
...
# CHIRPS
lat_end = which(lat < -22)[length(which(lat < -22))]
lat_start = which(lat > -44)[1]
lat_count = lat_end - lat_start + 1
